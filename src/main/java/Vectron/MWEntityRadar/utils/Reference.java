...
public class Reference
{
	...
	public static final String DEPENDENCIES = "required-after:MapWriter";
	...
	public static final ResourceLocation playerMPArrowTexture = new ResourceLocation(
			MOD_ID,
			"textures/radar/arrow_player_mp.png");

	public static SimpleNetworkWrapper simpleNetworkWrapper; // used to transmit
																// your network
																// messages
