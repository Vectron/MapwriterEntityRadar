...
public class MultiplayerManager {
	...
	public void updateMPPlayers()
	{
	    ...
	    while (it.hasNext()) {
	    	...
	    	EntityPlayer player = ProxyClient.mc.theWorld.getPlayerEntityByName(pair.getKey().toString());
	...
	public void DrawArrows(MapMode mapMode, MapView mapView)
	{
    ...
    public void addPlayer(EntityOtherPlayerMP playerMP){
    	String Name = playerMP.getDisplayName();
